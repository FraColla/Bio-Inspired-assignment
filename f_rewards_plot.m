...
hold on
grid on
plot(t, episodeReward, 'Color', [0.3010 0.7450 0.9330], 'LineWidth', 1.5, 'DisplayName', 'Episode Reward')
plot(t, averageReward, 'Color', [0 0.4470 0.7410], 'LineWidth', 1.5, 'DisplayName', 'Average reward (50 episodes)')
